...
# app = Flask(__name__)
# app = Flask(__name__, template_folder='F:\\mktlogin_2023\\views\\app_pages\\page_rpa\\blockly\\demos\\blockfactory', static_folder='../static')
# app = Flask(__name__, template_folder='F:\\mktlogin_2023\\views\\app_pages\\page_rpa\\blockly\\demos\\blockfactory')
app = Flask(__name__, template_folder=os.path.join(os.path.abspath(''), 'views\\app_pages\\page_rpa\\blockly\\demos\\blockfactory'))
# #print(os.path.join(os.path.abspath(''), 'views\\app_pages\\page_rpa\\blockly\\demos\\blockfactory'))
pids = []
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=7195, debug=True)